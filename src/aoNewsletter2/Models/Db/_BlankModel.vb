...
Namespace Models.Db
    Public Class BlankModel
        ...
        Public Shared Function createOrAddSettings(ByVal cp As CPBaseClass, ByVal settingsGuid As String) As BlankModel
            Dim result As BlankModel = create(Of BlankModel)(cp, settingsGuid)
